 ...
 *
 * This component sets up the global layout, initializes core systems like
 * audio and auto-player, and renders all primary UI overlays and screens.
 ...
 * @param masterVol   Current master volume (0-1), applied as a multiplier.
 * @param musicVol    Current music sub-volume (0-1), applied as a multiplier.
 */

 ...
 * on-demand and cached for subsequent plays. The system supports smooth crossfades
 ...
 *
 * Missing files are logged in development mode but otherwise fail silently.
 *
 ...
 * @param {AmbianceTrack} track - The track name to retrieve.

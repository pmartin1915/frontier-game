...
/**
 * Currently active track name, or null if none.
...
/**
 * Reference to a track that is currently fading out, allowing immediate
 * cancellation if a new track switch occurs before fade completes.
...
/**
 * Determines if the current environment supports audio playback.
 ...
 * @returns {Howl} Configured Howl instance.
 */

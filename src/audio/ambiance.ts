 ...
 * @param masterVol Current master volume (0-1), applied globally.
 * @param musicVol Current music sub-volume (0-1), specific to music.
 */
 ...
 * This also clears any track that might be in the middle of fading out.
 */

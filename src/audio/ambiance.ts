 ...
 * Tracks are created on first access to avoid loading everything upfront.
...
/**
 * Reference to a track that is currently fading out.
 * Used to cancel and stop it immediately if a new switch arrives before fade completes.
...
/**
 * Determines if the environment is a browser with audio capabilities.
 * @returns {boolean} True if running in a browser environment with AudioContext.
 */

 ...
 * These correspond to filenames in public/audio/ambient/ without extensions.
 *
 ...
 * @param {AmbianceTrack} track - The track to create
 ...
 * @param {AmbianceTrack} track - The track to get
